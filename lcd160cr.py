...
''',
    ...
    shed.def_(
        ...
        new='def get_line(self, x: int, y: int, buf: _AnyWritableBuf, /) -> None',
    )
    shed.def_(
...
''',
    ...
    shed.def_(
        old='.. method:: LCD160CR.write(s)',
        new='def write(self, s: str, /) -> None',
    )
    shed.def_(
    ...
    shed.def_(
        old='.. method:: LCD160CR.erase()',
        new='def erase(self) -> None',
    )
    shed.def_(
