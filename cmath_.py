...
''',
    ...
    shed.def_(
        old='.. function:: cos(z)',
        new='def cos(z: _C, /) -> complex',
        indent=0,
    )
    shed.def_(
        old='.. function:: exp(z)',
        new='def exp(z: _C, /) -> complex',
        indent=0,
    )
    shed.def_(
        old='.. function:: log(z)',
        new='def log(z: _C, /) -> complex',
        indent=0,
    )
    shed.def_(
        old='.. function:: log10(z)',
        new='def log10(z: _C, /) -> complex',
        indent=0,
    )
    shed.def_(
        old='.. function:: phase(z)',
        new='def phase(z: _C, /) -> float',
        indent=0,
    )
    shed.def_(
