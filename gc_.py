...
def gc(shed: RST2PyI) -> None:
    ...
    shed.def_(
        old='.. function:: disable()',
        new='def disable() -> None',
        indent=0,
    )
    shed.def_(
        old='.. function:: collect()',
        new='def collect() -> None',
        indent=0,
    )
    shed.def_(
        old='.. function:: mem_alloc()',
        new='def mem_alloc() -> int',
        indent=0,
    )
    shed.def_(
        old='.. function:: mem_free()',
        new='def mem_free() -> int',
        indent=0,
    )
    shed.def_(
